			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form:form id="login-form" commandName="userBean" action="/championship/app/login" method="post" role="form"
									style="display: block;">
									<div class="form-group">
										<form:input path="email" type="text" name="username" id="username" tabindex="1"
